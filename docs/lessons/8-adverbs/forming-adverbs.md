...
|                               |                 |
|:-----------------------------:|:---------------:|
|   Lènto ➜ Lènta ➜ Lentamente  |  Slow ➜ Slowly  |
| Ràpido ➜ Ràpida ➜ Ràpidamente | Quick ➜ Quickly |
...
|                               |                 |
|:-----------------------------:|:---------------:|
|   Intelligènte ➜ Intelligentemente  |  Intelligent ➜ Intelligently  |
| Frequènte ➜ Frequentemente | Frequent ➜ Frequently |
...
|                               |                 |
|:-----------------------------:|:---------------:|
|   Intelligènte ➜ Intelligènta ➜ Intelligentamente  |  Intelligent ➜ Intelligently  |
| Frequènte ➜ Frequènta ➜ Frequentamente | Frequent ➜ Frequently |
...
|                               |                 |
|:-----------------------------:|:---------------:|
|   Fàcile ➜ Fàcilemente  |  Easy ➜ Easily  |
| Generale ➜ Generalemente | General ➜ Generally |
| Possíbile ➜ Possíbilemente | Possible ➜ Possibly |

For the natural method, remove the **-e** at the end and add **-mente**.

|                               |                 |
|:-----------------------------:|:---------------:|
|   Fàcile ➜ Fàcilmente  |  Easy ➜ Easily  |
| Generale ➜ Generalmente | General ➜ Generally |
| Possíbile ➜ Possíbilmente | Possible ➜ Possibly |
