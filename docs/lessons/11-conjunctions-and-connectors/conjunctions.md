...
|                  Conjunction                 |      Translation      |                                            Example                                            |                              Translation                             |
|:--------------------------------------------:|:---------------------:|:---------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------:|
|        Por que (Requires subjunctive)        | So that / In order to |                           Accendei la luce por que potéssemos vedere.                           |                I turned on the light so we could see.                |
|      Ad fine que (Requires subjunctive)      | So that / In order to |                         Accendei la luce ad fine que potéssemos vedere.                         |                I turned on the light so we could see.                |
